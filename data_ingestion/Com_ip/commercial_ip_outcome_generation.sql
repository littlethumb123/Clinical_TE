/*==============================================================================
  ...
  Timeline Alignment with Transformer Features:
  - Uses SAME membership base: a834793_Commercial_member (2023 calendar year)
  ...
  - Final table: a834793_Commercial_final_dataset_4_te_experiment
  ...
  ⚠️ RETRAINING: When retraining transformer, regenerate this table AFTER
     regenerating a834793_Commercial_member to ensure index_dt alignment.
...
/*==============================================================================
  ...
  Purpose: Extract the membership base from transformer training table and
           enrich with demographics and membership attributes
  
  Source: a834793_Commercial_member_o3_train_ending (transformer training data)
  ...
  Note: This ensures we use the EXACT SAME cohort and index_dt values that
        the transformer was trained on, guaranteeing perfect alignment.
  
==============================================================================*/

DROP TABLE IF EXISTS `edp-prod-storage.edp_ent_sdoheir_cns.a834793_Commercial_member_base_4_te_experiment`;
CREATE OR REPLACE TABLE `edp-prod-storage.edp_ent_sdoheir_cns.a834793_Commercial_member_base_4_te_experiment`
OPTIONS (
...
AS
WITH base AS (
    -- Get transformer cohort (individual_id, index_dt)
    SELECT DISTINCT 
        individual_id
        , index_dt 
    FROM `edp-prod-storage.edp_ent_sdoheir_cns.a834793_Commercial_member_o3_train_ending`
),
base_with_member AS (
...
DROP TABLE IF EXISTS `edp-prod-storage.edp_ent_sdoheir_cns.a834793_Commercial_hpd_extract_4_te_experiment`;
CREATE OR REPLACE TABLE `edp-prod-storage.edp_ent_sdoheir_cns.a834793_Commercial_hpd_extract_4_te_experiment`
OPTIONS (
    labels = [("owner", "pritha_ghosh_cvshealth_com"),("cost_center", "13070")]
    , expiration_timestamp = TIMESTAMP_ADD(CURRENT_TIMESTAMP(), INTERVAL 1 DAY)
)
...
SELECT DISTINCT 
    ...
    , hpd.first_indctn_dt
FROM `edp-prod-storage.edp_ent_sdoheir_cns.a834793_Commercial_member_base_4_te_experiment` AS st
...
DROP TABLE IF EXISTS `edp-prod-storage.edp_ent_sdoheir_cns.a834793_Commercial_hpd_features_4_te_experiment`;
CREATE OR REPLACE TABLE `edp-prod-storage.edp_ent_sdoheir_cns.a834793_Commercial_hpd_features_4_te_experiment`
OPTIONS (
    labels = [("owner", "pritha_ghosh_cvshealth_com"),("cost_center", "13070")]
    , expiration_timestamp = TIMESTAMP_ADD(CURRENT_TIMESTAMP(), INTERVAL 1 DAY)
)
...
FROM `edp-prod-storage.edp_ent_sdoheir_cns.a834793_Commercial_member_base_4_te_experiment` AS st
LEFT JOIN `edp-prod-storage.edp_ent_sdoheir_cns.a834793_Commercial_hpd_extract_4_te_experiment` AS he 
...
DROP TABLE IF EXISTS `edp-prod-storage.edp_ent_sdoheir_cns.a834793_Commercial_mxclm_extract_4_te_experiment`;
CREATE OR REPLACE TABLE `edp-prod-storage.edp_ent_sdoheir_cns.a834793_Commercial_mxclm_extract_4_te_experiment`
OPTIONS (
    labels = [("owner", "pritha_ghosh_cvshealth_com"),("cost_center", "13070")]
    , expiration_timestamp = TIMESTAMP_ADD(CURRENT_TIMESTAMP(), INTERVAL 1 DAY)
)
...
DROP TABLE IF EXISTS `edp-prod-storage.edp_ent_sdoheir_cns.a834793_Commercial_medcs_extract_4_te_experiment`;
CREATE OR REPLACE TABLE `edp-prod-storage.edp_ent_sdoheir_cns.a834793_Commercial_medcs_extract_4_te_experiment`
OPTIONS (
    labels = [("owner", "pritha_ghosh_cvshealth_com"),("cost_center", "13070")]
    , expiration_timestamp = TIMESTAMP_ADD(CURRENT_TIMESTAMP(), INTERVAL 1 DAY)
)
...
DROP TABLE IF EXISTS `edp-prod-storage.edp_ent_sdoheir_cns.a834793_Commercial_medcsfac_extract_4_te_experiment`;
CREATE OR REPLACE TABLE `edp-prod-storage.edp_ent_sdoheir_cns.a834793_Commercial_medcsfac_extract_4_te_experiment`
OPTIONS (
    labels = [("owner", "pritha_ghosh_cvshealth_com"),("cost_center", "13070")]
    , expiration_timestamp = TIMESTAMP_ADD(CURRENT_TIMESTAMP(), INTERVAL 1 DAY)
)
...
DROP TABLE IF EXISTS `edp-prod-storage.edp_ent_sdoheir_cns.a834793_Commercial_medcsclm_extract_4_te_experiment`;
CREATE OR REPLACE TABLE `edp-prod-storage.edp_ent_sdoheir_cns.a834793_Commercial_medcsclm_extract_4_te_experiment`
OPTIONS (
    labels = [("owner", "pritha_ghosh_cvshealth_com"),("cost_center", "13070")]
    , expiration_timestamp = TIMESTAMP_ADD(CURRENT_TIMESTAMP(), INTERVAL 1 DAY)
)
...
SELECT DISTINCT
    ...
    , emc.medical_case_id
    , emccl.claim_line_id
FROM `edp-prod-storage.edp_ent_sdoheir_cns.a834793_Commercial_medcs_extract_4_te_experiment` AS emc
...
DROP TABLE IF EXISTS `edp-prod-storage.edp_ent_sdoheir_cns.a834793_Commercial_medcs1_4_te_experiment`;
CREATE OR REPLACE TABLE `edp-prod-storage.edp_ent_sdoheir_cns.a834793_Commercial_medcs1_4_te_experiment`
OPTIONS (
    labels = [("owner", "pritha_ghosh_cvshealth_com"),("cost_center", "13070")]
    , expiration_timestamp = TIMESTAMP_ADD(CURRENT_TIMESTAMP(), INTERVAL 1 DAY)
)
...
SELECT 
    ...
    , me1.mdc_cd
    , me1.los_day_cnt
FROM `edp-prod-storage.edp_ent_sdoheir_cns.a834793_Commercial_medcs_extract_4_te_experiment` AS me1
INNER JOIN `edp-prod-storage.edp_ent_sdoheir_cns.a834793_Commercial_medcsclm_extract_4_te_experiment` AS me2 
...
DROP TABLE IF EXISTS `edp-prod-storage.edp_ent_sdoheir_cns.a834793_Commercial_medcs2_4_te_experiment`;
CREATE OR REPLACE TABLE `edp-prod-storage.edp_ent_sdoheir_cns.a834793_Commercial_medcs2_4_te_experiment`
OPTIONS (
    labels = [("owner", "pritha_ghosh_cvshealth_com"),("cost_center", "13070")]
    , expiration_timestamp = TIMESTAMP_ADD(CURRENT_TIMESTAMP(), INTERVAL 1 DAY)
)
...
SELECT 
    ...
    , m.mdc_cd
    , m.los_day_cnt
FROM `edp-prod-storage.edp_ent_sdoheir_cns.a834793_Commercial_medcs1_4_te_experiment` AS m
INNER JOIN `edp-prod-storage.edp_ent_sdoheir_cns.a834793_Commercial_mxclm_extract_4_te_experiment` AS me 
...
DROP TABLE IF EXISTS `edp-prod-storage.edp_ent_sdoheir_cns.a834793_Commercial_medcs3_4_te_experiment`;
CREATE OR REPLACE TABLE `edp-prod-storage.edp_ent_sdoheir_cns.a834793_Commercial_medcs3_4_te_experiment`
OPTIONS (
    labels = [("owner", "pritha_ghosh_cvshealth_com"),("cost_center", "13070")]
    , expiration_timestamp = TIMESTAMP_ADD(CURRENT_TIMESTAMP(), INTERVAL 1 DAY)
)
...
SELECT 
    ...
    , m.los_day_cnt
    , me.fac_spec_ctg_cd
FROM `edp-prod-storage.edp_ent_sdoheir_cns.a834793_Commercial_medcs2_4_te_experiment` AS m
LEFT JOIN `edp-prod-storage.edp_ent_sdoheir_cns.a834793_Commercial_medcsfac_extract_4_te_experiment` AS me 
    ON m.member_id = me.member_id 
...
DROP TABLE IF EXISTS `edp-prod-storage.edp_ent_sdoheir_cns.a834793_Commercial_medcs_2yr_4_te_experiment`;
CREATE OR REPLACE TABLE `edp-prod-storage.edp_ent_sdoheir_cns.a834793_Commercial_medcs_2yr_4_te_experiment`
OPTIONS (
    labels = [("owner", "pritha_ghosh_cvshealth_com"),("cost_center", "13070")]
    , expiration_timestamp = TIMESTAMP_ADD(CURRENT_TIMESTAMP(), INTERVAL 1 DAY)
)
...
FROM `edp-prod-storage.edp_ent_sdoheir_cns.a834793_Commercial_member_base_4_te_experiment` AS st
LEFT JOIN `edp-prod-storage.edp_ent_sdoheir_cns.a834793_Commercial_medcs3_4_te_experiment` AS m 
...
DROP TABLE IF EXISTS `edp-prod-storage.edp_ent_sdoheir_cns.a834793_Commercial_medcs_1yr_4_te_experiment`;
CREATE OR REPLACE TABLE `edp-prod-storage.edp_ent_sdoheir_cns.a834793_Commercial_medcs_1yr_4_te_experiment`
OPTIONS (
    labels = [("owner", "pritha_ghosh_cvshealth_com"),("cost_center", "13070")]
    , expiration_timestamp = TIMESTAMP_ADD(CURRENT_TIMESTAMP(), INTERVAL 1 DAY)
)
...
DROP TABLE IF EXISTS `edp-prod-storage.edp_ent_sdoheir_cns.a834793_Commercial_medcs_6mo_4_te_experiment`;
CREATE OR REPLACE TABLE `edp-prod-storage.edp_ent_sdoheir_cns.a834793_Commercial_medcs_6mo_4_te_experiment`
OPTIONS (
    labels = [("owner", "pritha_ghosh_cvshealth_com"),("cost_center", "13070")]
    , expiration_timestamp = TIMESTAMP_ADD(CURRENT_TIMESTAMP(), INTERVAL 1 DAY)
)
...
DROP TABLE IF EXISTS `edp-prod-storage.edp_ent_sdoheir_cns.a834793_Commercial_medcs_3mo_4_te_experiment`;
CREATE OR REPLACE TABLE `edp-prod-storage.edp_ent_sdoheir_cns.a834793_Commercial_medcs_3mo_4_te_experiment`
OPTIONS (
    labels = [("owner", "pritha_ghosh_cvshealth_com"),("cost_center", "13070")]
    , expiration_timestamp = TIMESTAMP_ADD(CURRENT_TIMESTAMP(), INTERVAL 1 DAY)
)
...
DROP TABLE IF EXISTS `edp-prod-storage.edp_ent_sdoheir_cns.a834793_Commercial_medcs_features_4_te_experiment`;
CREATE OR REPLACE TABLE `edp-prod-storage.edp_ent_sdoheir_cns.a834793_Commercial_medcs_features_4_te_experiment`
OPTIONS (
    labels = [("owner", "pritha_ghosh_cvshealth_com"),("cost_center", "13070")]
    , expiration_timestamp = TIMESTAMP_ADD(CURRENT_TIMESTAMP(), INTERVAL 1 DAY)
)
...
FROM `edp-prod-storage.edp_ent_sdoheir_cns.a834793_Commercial_medcs_2yr_4_te_experiment` AS m1
INNER JOIN `edp-prod-storage.edp_ent_sdoheir_cns.a834793_Commercial_medcs_1yr_4_te_experiment` AS m2 
    ON m1.individual_id = m2.individual_id 
    AND m1.index_dt = m2.index_dt
INNER JOIN `edp-prod-storage.edp_ent_sdoheir_cns.a834793_Commercial_medcs_6mo_4_te_experiment` AS m3 
    ON m1.individual_id = m3.individual_id 
    AND m1.index_dt = m3.index_dt
INNER JOIN `edp-prod-storage.edp_ent_sdoheir_cns.a834793_Commercial_medcs_3mo_4_te_experiment` AS m4 
...
-- 2-year MDC counts
DROP TABLE IF EXISTS `edp-prod-storage.edp_ent_sdoheir_cns.a834793_Commercial_medcs_mdc2yr_4_te_experiment`;
CREATE OR REPLACE TABLE `edp-prod-storage.edp_ent_sdoheir_cns.a834793_Commercial_medcs_mdc2yr_4_te_experiment`
OPTIONS (
    labels = [("owner", "pritha_ghosh_cvshealth_com"),("cost_center", "13070")]
    , expiration_timestamp = TIMESTAMP_ADD(CURRENT_TIMESTAMP(), INTERVAL 1 DAY)
)
...
FROM `edp-prod-storage.edp_ent_sdoheir_cns.a834793_Commercial_medcs3_4_te_experiment` AS m
...
-- 1-year MDC counts
DROP TABLE IF EXISTS `edp-prod-storage.edp_ent_sdoheir_cns.a834793_Commercial_medcs_mdc1yr_4_te_experiment`;
CREATE OR REPLACE TABLE `edp-prod-storage.edp_ent_sdoheir_cns.a834793_Commercial_medcs_mdc1yr_4_te_experiment`
OPTIONS (
    labels = [("owner", "pritha_ghosh_cvshealth_com"),("cost_center", "13070")]
    , expiration_timestamp = TIMESTAMP_ADD(CURRENT_TIMESTAMP(), INTERVAL 1 DAY)
)
...
-- 6-month MDC counts
DROP TABLE IF EXISTS `edp-prod-storage.edp_ent_sdoheir_cns.a834793_Commercial_medcs_mdc6mo_4_te_experiment`;
CREATE OR REPLACE TABLE `edp-prod-storage.edp_ent_sdoheir_cns.a834793_Commercial_medcs_mdc6mo_4_te_experiment`
OPTIONS (
    labels = [("owner", "pritha_ghosh_cvshealth_com"),("cost_center", "13070")]
    , expiration_timestamp = TIMESTAMP_ADD(CURRENT_TIMESTAMP(), INTERVAL 1 DAY)
)
...
-- 3-month MDC counts
DROP TABLE IF EXISTS `edp-prod-storage.edp_ent_sdoheir_cns.a834793_Commercial_medcs_mdc3mo_4_te_experiment`;
CREATE OR REPLACE TABLE `edp-prod-storage.edp_ent_sdoheir_cns.a834793_Commercial_medcs_mdc3mo_4_te_experiment`
OPTIONS (
    labels = [("owner", "pritha_ghosh_cvshealth_com"),("cost_center", "13070")]
    , expiration_timestamp = TIMESTAMP_ADD(CURRENT_TIMESTAMP(), INTERVAL 1 DAY)
)
...
-- 2-year MDC pivot
DROP TABLE IF EXISTS `edp-prod-storage.edp_ent_sdoheir_cns.a834793_Commercial_medcs_mdc2yr2_4_te_experiment`;
CREATE OR REPLACE TABLE `edp-prod-storage.edp_ent_sdoheir_cns.a834793_Commercial_medcs_mdc2yr2_4_te_experiment`
OPTIONS (
    labels = [("owner", "pritha_ghosh_cvshealth_com"),("cost_center", "13070")]
    , expiration_timestamp = TIMESTAMP_ADD(CURRENT_TIMESTAMP(), INTERVAL 1 DAY)
)
...
WITH st AS (
    ...
    FROM `edp-prod-storage.edp_ent_sdoheir_cns.a834793_Commercial_member_base_4_te_experiment`
)
SELECT 
        st.individual_id
        , st.index_dt
...
FROM st
LEFT JOIN `edp-prod-storage.edp_ent_sdoheir_cns.a834793_Commercial_medcs_mdc2yr_4_te_experiment` AS md 
...
-- 1-year MDC pivot
DROP TABLE IF EXISTS `edp-prod-storage.edp_ent_sdoheir_cns.a834793_Commercial_medcs_mdc1yr2_4_te_experiment`;
CREATE OR REPLACE TABLE `edp-prod-storage.edp_ent_sdoheir_cns.a834793_Commercial_medcs_mdc1yr2_4_te_experiment`
OPTIONS (
    labels = [("owner", "pritha_ghosh_cvshealth_com"),("cost_center", "13070")]
    , expiration_timestamp = TIMESTAMP_ADD(CURRENT_TIMESTAMP(), INTERVAL 1 DAY)
)
...
FROM st
LEFT JOIN `edp-prod-storage.edp_ent_sdoheir_cns.a834793_Commercial_medcs_mdc1yr_4_te_experiment` AS md 
    ON st.individual_id = md.individual_id 
    AND st.index_dt = md.index_dt
GROUP BY st.individual_id, st.index_dt
;
...
-- 6-month MDC pivot
DROP TABLE IF EXISTS `edp-prod-storage.edp_ent_sdoheir_cns.a834793_Commercial_medcs_mdc6mo2_4_te_experiment`;
CREATE OR REPLACE TABLE `edp-prod-storage.edp_ent_sdoheir_cns.a834793_Commercial_medcs_mdc6mo2_4_te_experiment`
OPTIONS (
    labels = [("owner", "pritha_ghosh_cvshealth_com"),("cost_center", "13070")]
    , expiration_timestamp = TIMESTAMP_ADD(CURRENT_TIMESTAMP(), INTERVAL 1 DAY)
)
...
FROM st
LEFT JOIN `edp-prod-storage.edp_ent_sdoheir_cns.a834793_Commercial_medcs_mdc6mo_4_te_experiment` AS md 
    ON st.individual_id = md.individual_id 
    AND st.index_dt = md.index_dt
GROUP BY st.individual_id, st.index_dt
;
...
-- 3-month MDC pivot
DROP TABLE IF EXISTS `edp-prod-storage.edp_ent_sdoheir_cns.a834793_Commercial_medcs_mdc3mo2_4_te_experiment`;
CREATE OR REPLACE TABLE `edp-prod-storage.edp_ent_sdoheir_cns.a834793_Commercial_medcs_mdc3mo2_4_te_experiment`
OPTIONS (
    labels = [("owner", "pritha_ghosh_cvshealth_com"),("cost_center", "13070")]
    , expiration_timestamp = TIMESTAMP_ADD(CURRENT_TIMESTAMP(), INTERVAL 1 DAY)
)
...
FROM st
LEFT JOIN `edp-prod-storage.edp_ent_sdoheir_cns.a834793_Commercial_medcs_mdc3mo_4_te_experiment` AS md 
    ON st.individual_id = md.individual_id 
    AND st.index_dt = md.index_dt
GROUP BY st.individual_id, st.index_dt
;
...
DROP TABLE IF EXISTS `edp-prod-storage.edp_ent_sdoheir_cns.a834793_Commercial_medcs_mdc_features_4_te_experiment`;
CREATE OR REPLACE TABLE `edp-prod-storage.edp_ent_sdoheir_cns.a834793_Commercial_medcs_mdc_features_4_te_experiment`
OPTIONS (
    labels = [("owner", "pritha_ghosh_cvshealth_com"),("cost_center", "13070")]
    , expiration_timestamp = TIMESTAMP_ADD(CURRENT_TIMESTAMP(), INTERVAL 1 DAY)
)
...
FROM `edp-prod-storage.edp_ent_sdoheir_cns.a834793_Commercial_medcs_mdc2yr2_4_te_experiment` AS mm1
INNER JOIN `edp-prod-storage.edp_ent_sdoheir_cns.a834793_Commercial_medcs_mdc1yr2_4_te_experiment` AS mm2 
    ON mm1.individual_id = mm2.individual_id 
    AND mm1.index_dt = mm2.index_dt
INNER JOIN `edp-prod-storage.edp_ent_sdoheir_cns.a834793_Commercial_medcs_mdc6mo2_4_te_experiment` AS mm3 
    ON mm1.individual_id = mm3.individual_id 
    AND mm1.index_dt = mm3.index_dt
INNER JOIN `edp-prod-storage.edp_ent_sdoheir_cns.a834793_Commercial_medcs_mdc3mo2_4_te_experiment` AS mm4 
...
DROP TABLE IF EXISTS `edp-prod-storage.edp_ent_sdoheir_cns.a834793_Commercial_labrslt_extract_4_te_experiment`;
CREATE OR REPLACE TABLE `edp-prod-storage.edp_ent_sdoheir_cns.a834793_Commercial_labrslt_extract_4_te_experiment`
OPTIONS (
    labels = [("owner", "pritha_ghosh_cvshealth_com"),("cost_center", "13070")]
    , expiration_timestamp = TIMESTAMP_ADD(CURRENT_TIMESTAMP(), INTERVAL 1 DAY)
)
...
DROP TABLE IF EXISTS `edp-prod-storage.edp_ent_sdoheir_cns.a834793_Commercial_lab2yr_4_te_experiment`;
CREATE OR REPLACE TABLE `edp-prod-storage.edp_ent_sdoheir_cns.a834793_Commercial_lab2yr_4_te_experiment`
OPTIONS (
    labels = [("owner", "pritha_ghosh_cvshealth_com"),("cost_center", "13070")]
    , expiration_timestamp = TIMESTAMP_ADD(CURRENT_TIMESTAMP(), INTERVAL 1 DAY)
)
...
FROM `edp-prod-storage.edp_ent_sdoheir_cns.a834793_Commercial_member_base_4_te_experiment` AS st
LEFT JOIN `edp-prod-storage.edp_ent_sdoheir_cns.a834793_Commercial_labrslt_extract_4_te_experiment` AS le 
...
DROP TABLE IF EXISTS `edp-prod-storage.edp_ent_sdoheir_cns.a834793_Commercial_lab1yr_4_te_experiment`;
CREATE OR REPLACE TABLE `edp-prod-storage.edp_ent_sdoheir_cns.a834793_Commercial_lab1yr_4_te_experiment`
OPTIONS (
    labels = [("owner", "pritha_ghosh_cvshealth_com"),("cost_center", "13070")]
    , expiration_timestamp = TIMESTAMP_ADD(CURRENT_TIMESTAMP(), INTERVAL 1 DAY)
)
...
DROP TABLE IF EXISTS `edp-prod-storage.edp_ent_sdoheir_cns.a834793_Commercial_labrslt_features_4_te_experiment`;
CREATE OR REPLACE TABLE `edp-prod-storage.edp_ent_sdoheir_cns.a834793_Commercial_labrslt_features_4_te_experiment`
OPTIONS (
    labels = [("owner", "pritha_ghosh_cvshealth_com"),("cost_center", "13070")]
    , expiration_timestamp = TIMESTAMP_ADD(CURRENT_TIMESTAMP(), INTERVAL 1 DAY)
)
...
SELECT 
    ...
    , l2.lab_sodium_1yr
    , l2.lab_triglyc_1yr
FROM `edp-prod-storage.edp_ent_sdoheir_cns.a834793_Commercial_lab2yr_4_te_experiment` AS l1
INNER JOIN `edp-prod-storage.edp_ent_sdoheir_cns.a834793_Commercial_lab1yr_4_te_experiment` AS l2 
...
DROP TABLE IF EXISTS `edp-prod-storage.edp_ent_sdoheir_cns.a834793_Commercial_mm_4_te_experiment`;
CREATE OR REPLACE TABLE `edp-prod-storage.edp_ent_sdoheir_cns.a834793_Commercial_mm_4_te_experiment`
OPTIONS (
    labels = [("owner", "pritha_ghosh_cvshealth_com"),("cost_center", "13070")]
    , expiration_timestamp = TIMESTAMP_ADD(CURRENT_TIMESTAMP(), INTERVAL 1 DAY)
)
...
DROP TABLE IF EXISTS `edp-prod-storage.edp_ent_sdoheir_cns.a834793_Commercial_mm2yr_4_te_experiment`;
CREATE OR REPLACE TABLE `edp-prod-storage.edp_ent_sdoheir_cns.a834793_Commercial_mm2yr_4_te_experiment`
OPTIONS (
    labels = [("owner", "pritha_ghosh_cvshealth_com"),("cost_center", "13070")]
    , expiration_timestamp = TIMESTAMP_ADD(CURRENT_TIMESTAMP(), INTERVAL 1 DAY)
)
...
WITH other AS (
    ...
    FROM `edp-prod-storage.edp_ent_sdoheir_cns.a834793_Commercial_mm_4_te_experiment`
)
SELECT 
    m.individual_id
    , m.index_dt
...
FROM `edp-prod-storage.edp_ent_sdoheir_cns.a834793_Commercial_mm_4_te_experiment` AS m
JOIN other o
...
DROP TABLE IF EXISTS `edp-prod-storage.edp_ent_sdoheir_cns.a834793_Commercial_mm1yr_4_te_experiment`;
CREATE OR REPLACE TABLE `edp-prod-storage.edp_ent_sdoheir_cns.a834793_Commercial_mm1yr_4_te_experiment`
OPTIONS (
    labels = [("owner", "pritha_ghosh_cvshealth_com"),("cost_center", "13070")]
    , expiration_timestamp = TIMESTAMP_ADD(CURRENT_TIMESTAMP(), INTERVAL 1 DAY)
)
...
DROP TABLE IF EXISTS `edp-prod-storage.edp_ent_sdoheir_cns.a834793_Commercial_mm6mo_4_te_experiment`;
CREATE OR REPLACE TABLE `edp-prod-storage.edp_ent_sdoheir_cns.a834793_Commercial_mm6mo_4_te_experiment`
OPTIONS (
    labels = [("owner", "pritha_ghosh_cvshealth_com"),("cost_center", "13070")]
    , expiration_timestamp = TIMESTAMP_ADD(CURRENT_TIMESTAMP(), INTERVAL 1 DAY)
)
...
DROP TABLE IF EXISTS `edp-prod-storage.edp_ent_sdoheir_cns.a834793_Commercial_mm3mo_4_te_experiment`;
CREATE OR REPLACE TABLE `edp-prod-storage.edp_ent_sdoheir_cns.a834793_Commercial_mm3mo_4_te_experiment`
OPTIONS (
    labels = [("owner", "pritha_ghosh_cvshealth_com"),("cost_center", "13070")]
    , expiration_timestamp = TIMESTAMP_ADD(CURRENT_TIMESTAMP(), INTERVAL 1 DAY)
)
...
DROP TABLE IF EXISTS `edp-prod-storage.edp_ent_sdoheir_cns.a834793_Commercial_mm_features_4_te_experiment`;
CREATE OR REPLACE TABLE `edp-prod-storage.edp_ent_sdoheir_cns.a834793_Commercial_mm_features_4_te_experiment`
OPTIONS (
    labels = [("owner", "pritha_ghosh_cvshealth_com"),("cost_center", "13070")]
    , expiration_timestamp = TIMESTAMP_ADD(CURRENT_TIMESTAMP(), INTERVAL 1 DAY)
)
...
FROM st
LEFT JOIN `edp-prod-storage.edp_ent_sdoheir_cns.a834793_Commercial_mm2yr_4_te_experiment` AS m1 
    ON st.individual_id = m1.individual_id AND st.index_dt = m1.index_dt
LEFT JOIN `edp-prod-storage.edp_ent_sdoheir_cns.a834793_Commercial_mm1yr_4_te_experiment` AS m2 
    ON st.individual_id = m2.individual_id AND st.index_dt = m2.index_dt
LEFT JOIN `edp-prod-storage.edp_ent_sdoheir_cns.a834793_Commercial_mm6mo_4_te_experiment` AS m3 
    ON st.individual_id = m3.individual_id AND st.index_dt = m3.index_dt
LEFT JOIN `edp-prod-storage.edp_ent_sdoheir_cns.a834793_Commercial_mm3mo_4_te_experiment` AS m4 
...
DROP TABLE IF EXISTS `edp-prod-storage.edp_ent_sdoheir_cns.a834793_Commercial_mbrshp_extract_4_te_experiment`;
CREATE OR REPLACE TABLE `edp-prod-storage.edp_ent_sdoheir_cns.a834793_Commercial_mbrshp_extract_4_te_experiment`
OPTIONS (
    labels = [("owner", "pritha_ghosh_cvshealth_com"),("cost_center", "13070")]
    , expiration_timestamp = TIMESTAMP_ADD(CURRENT_TIMESTAMP(), INTERVAL 1 DAY)
)
...
DROP TABLE IF EXISTS `edp-prod-storage.edp_ent_sdoheir_cns.a834793_Commercial_mbrshp_4_te_experiment`;
CREATE OR REPLACE TABLE `edp-prod-storage.edp_ent_sdoheir_cns.a834793_Commercial_mbrshp_4_te_experiment`
OPTIONS (
    labels = [("owner", "pritha_ghosh_cvshealth_com"),("cost_center", "13070")]
    , expiration_timestamp = TIMESTAMP_ADD(CURRENT_TIMESTAMP(), INTERVAL 1 DAY)
)
...
WITH ind AS (
    ...
    INNER JOIN `edp-prod-hcbstorage.edp_hcb_core_cnsv.INDVDL_CUST_DIST` AS eicd2 
        ON eicd.individual_id = eicd2.individual_id
    LEFT JOIN `edp-prod-storage.edp_ent_sdoheir_cns.a834793_Commercial_mbrshp_extract_4_te_experiment` AS me 
...
DROP TABLE IF EXISTS `edp-prod-storage.edp_ent_sdoheir_cns.a834793_Commercial_mbrshp_features_4_te_experiment`;
CREATE OR REPLACE TABLE `edp-prod-storage.edp_ent_sdoheir_cns.a834793_Commercial_mbrshp_features_4_te_experiment`
OPTIONS (
    labels = [("owner", "pritha_ghosh_cvshealth_com"),("cost_center", "13070")]
    , expiration_timestamp = TIMESTAMP_ADD(CURRENT_TIMESTAMP(), INTERVAL 1 DAY)
)
...
FROM st
LEFT JOIN `edp-prod-storage.edp_ent_sdoheir_cns.a834793_Commercial_mbrshp_4_te_experiment` AS mf 
    ON st.individual_id = mf.individual_id AND st.index_dt = mf.index_dt
LEFT JOIN `edp-prod-storage.edp_ent_sdoheir_cns.a834793_Commercial_mm_features_4_te_experiment` AS mm 
...
DROP TABLE IF EXISTS `edp-prod-storage.edp_ent_sdoheir_cns.a834793_Commercial_mbrrtp_extract_4_te_experiment`;
CREATE OR REPLACE TABLE `edp-prod-storage.edp_ent_sdoheir_cns.a834793_Commercial_mbrrtp_extract_4_te_experiment`
OPTIONS (
    labels = [("owner", "pritha_ghosh_cvshealth_com"),("cost_center", "13070")]
    , expiration_timestamp = TIMESTAMP_ADD(CURRENT_TIMESTAMP(), INTERVAL 1 DAY)
)
...
DROP TABLE IF EXISTS `edp-prod-storage.edp_ent_sdoheir_cns.a834793_Commercial_mbrrtp1_4_te_experiment`;
CREATE OR REPLACE TABLE `edp-prod-storage.edp_ent_sdoheir_cns.a834793_Commercial_mbrrtp1_4_te_experiment`
OPTIONS (
    labels = [("owner", "pritha_ghosh_cvshealth_com"),("cost_center", "13070")]
    , expiration_timestamp = TIMESTAMP_ADD(CURRENT_TIMESTAMP(), INTERVAL 1 DAY)
)
...
SELECT DISTINCT 
    ...
    , me.fam_member_id
    , me.mbr_rtp_type_cd
FROM `edp-prod-storage.edp_ent_sdoheir_cns.a834793_Commercial_mbrrtp_extract_4_te_experiment` AS me
...
DROP TABLE IF EXISTS `edp-prod-storage.edp_ent_sdoheir_cns.a834793_Commercial_mbrrtp_features_4_te_experiment`;
CREATE OR REPLACE TABLE `edp-prod-storage.edp_ent_sdoheir_cns.a834793_Commercial_mbrrtp_features_4_te_experiment`
OPTIONS (
    labels = [("owner", "pritha_ghosh_cvshealth_com"),("cost_center", "13070")]
    , expiration_timestamp = TIMESTAMP_ADD(CURRENT_TIMESTAMP(), INTERVAL 1 DAY)
)
...
SELECT 
    ...
    , MAX(CASE 
      ...
      END) AS member_type
FROM `edp-prod-storage.edp_ent_sdoheir_cns.a834793_Commercial_member_base_4_te_experiment` AS st
LEFT JOIN `edp-prod-storage.edp_ent_sdoheir_cns.a834793_Commercial_mbrrtp1_4_te_experiment` AS m 
    ON st.member_id = m.member_id 
...
DROP TABLE IF EXISTS `edp-prod-storage.edp_ent_sdoheir_cns.a834793_Commercial_claim_extract_4_te_experiment`;
CREATE OR REPLACE TABLE `edp-prod-storage.edp_ent_sdoheir_cns.a834793_Commercial_claim_extract_4_te_experiment`
OPTIONS (
    labels = [("owner", "pritha_ghosh_cvshealth_com"),("cost_center", "13070")]
    , expiration_timestamp = TIMESTAMP_ADD(CURRENT_TIMESTAMP(), INTERVAL 1 DAY)
)
...
FROM `edp-prod-storage.edp_ent_sdoheir_cns.a834793_Commercial_member_base_4_te_experiment` st
...
-- 2-year aggregation
DROP TABLE IF EXISTS `edp-prod-storage.edp_ent_sdoheir_cns.a834793_Commercial_cost_2y_4_te_experiment`;
CREATE OR REPLACE TABLE `edp-prod-storage.edp_ent_sdoheir_cns.a834793_Commercial_cost_2y_4_te_experiment`
OPTIONS (
    labels = [("owner", "pritha_ghosh_cvshealth_com"),("cost_center", "13070")]
    , expiration_timestamp = TIMESTAMP_ADD(CURRENT_TIMESTAMP(), INTERVAL 1 DAY)
)
...
FROM `edp-prod-storage.edp_ent_sdoheir_cns.a834793_Commercial_claim_extract_4_te_experiment` st
GROUP BY st.individual_id, st.index_dt
;

-- 1-year aggregation
DROP TABLE IF EXISTS `edp-prod-storage.edp_ent_sdoheir_cns.a834793_Commercial_cost_1y_4_te_experiment`;
CREATE OR REPLACE TABLE `edp-prod-storage.edp_ent_sdoheir_cns.a834793_Commercial_cost_1y_4_te_experiment`
OPTIONS (
    labels = [("owner", "pritha_ghosh_cvshealth_com"),("cost_center", "13070")]
    , expiration_timestamp = TIMESTAMP_ADD(CURRENT_TIMESTAMP(), INTERVAL 1 DAY)
)
...
-- 6-month aggregation
DROP TABLE IF EXISTS `edp-prod-storage.edp_ent_sdoheir_cns.a834793_Commercial_cost_6mo_4_te_experiment`;
CREATE OR REPLACE TABLE `edp-prod-storage.edp_ent_sdoheir_cns.a834793_Commercial_cost_6mo_4_te_experiment`
OPTIONS (
    labels = [("owner", "pritha_ghosh_cvshealth_com"),("cost_center", "13070")]
    , expiration_timestamp = TIMESTAMP_ADD(CURRENT_TIMESTAMP(), INTERVAL 1 DAY)
)
...
-- 3-month aggregation
DROP TABLE IF EXISTS `edp-prod-storage.edp_ent_sdoheir_cns.a834793_Commercial_cost_3mo_4_te_experiment`;
CREATE OR REPLACE TABLE `edp-prod-storage.edp_ent_sdoheir_cns.a834793_Commercial_cost_3mo_4_te_experiment`
OPTIONS (
    labels = [("owner", "pritha_ghosh_cvshealth_com"),("cost_center", "13070")]
    , expiration_timestamp = TIMESTAMP_ADD(CURRENT_TIMESTAMP(), INTERVAL 1 DAY)
)
...
DROP TABLE IF EXISTS `edp-prod-storage.edp_ent_sdoheir_cns.a834793_Commercial_cost_visit_features_4_te_experiment`;
CREATE OR REPLACE TABLE `edp-prod-storage.edp_ent_sdoheir_cns.a834793_Commercial_cost_visit_features_4_te_experiment`
OPTIONS (
    labels = [("owner", "pritha_ghosh_cvshealth_com"),("cost_center", "13070")]
    , expiration_timestamp = TIMESTAMP_ADD(CURRENT_TIMESTAMP(), INTERVAL 1 DAY)
)
...
WITH yr2 AS (
    ...
    FROM `edp-prod-storage.edp_ent_sdoheir_cns.a834793_Commercial_cost_2y_4_te_experiment` cs
    JOIN `edp-prod-storage.edp_ent_sdoheir_cns.a834793_Commercial_mm2yr_4_te_experiment` mm
...
, yr1 AS (
    ...
    FROM `edp-prod-storage.edp_ent_sdoheir_cns.a834793_Commercial_cost_1y_4_te_experiment` cs
    JOIN `edp-prod-storage.edp_ent_sdoheir_cns.a834793_Commercial_mm1yr_4_te_experiment` mm
        ON cs.individual_id = mm.individual_id AND cs.index_dt = mm.index_dt
)
, mon6 AS (
    SELECT cs.individual_id, cs.index_dt,
    ...
    FROM `edp-prod-storage.edp_ent_sdoheir_cns.a834793_Commercial_cost_6mo_4_te_experiment` cs
    JOIN `edp-prod-storage.edp_ent_sdoheir_cns.a834793_Commercial_mm6mo_4_te_experiment` mm
        ON cs.individual_id = mm.individual_id AND cs.index_dt = mm.index_dt
)
, mon3 AS (
    SELECT cs.individual_id, cs.index_dt,
    ...
    FROM `edp-prod-storage.edp_ent_sdoheir_cns.a834793_Commercial_cost_3mo_4_te_experiment` cs
    JOIN `edp-prod-storage.edp_ent_sdoheir_cns.a834793_Commercial_mm3mo_4_te_experiment` mm
        ON cs.individual_id = mm.individual_id AND cs.index_dt = mm.index_dt
)
, ind AS (
    SELECT DISTINCT individual_id, index_dt
...
DROP TABLE IF EXISTS `edp-prod-storage.edp_ent_sdoheir_cns.a834793_Commercial_post_status_4_te_experiment`;
CREATE OR REPLACE TABLE `edp-prod-storage.edp_ent_sdoheir_cns.a834793_Commercial_post_status_4_te_experiment`
OPTIONS (
    labels = [("owner", "pritha_ghosh_cvshealth_com"),("cost_center", "13070")]
    , expiration_timestamp = TIMESTAMP_ADD(CURRENT_TIMESTAMP(), INTERVAL 1 DAY)
)
...
post_3mo AS (
    ...
    FROM `edp-prod-storage.edp_ent_sdoheir_cns.a834793_Commercial_member_base_4_te_experiment` mm
...
DROP TABLE IF EXISTS `edp-prod-storage.edp_ent_sdoheir_cns.a834793_Commercial_outcome_ip_cases_4_te_experiment`;
CREATE OR REPLACE TABLE `edp-prod-storage.edp_ent_sdoheir_cns.a834793_Commercial_outcome_ip_cases_4_te_experiment`
OPTIONS (
    labels = [("owner", "pritha_ghosh_cvshealth_com"),("cost_center", "13070")]
    , expiration_timestamp = TIMESTAMP_ADD(CURRENT_TIMESTAMP(), INTERVAL 1 DAY)
)
...
FROM
    ...
    `edp-prod-storage.edp_ent_sdoheir_cns.a834793_Commercial_member_base_4_te_experiment` AS st
...
case_claims AS (
    SELECT 
        ...
        , mccl.claim_line_id
    FROM `edp-prod-storage.edp_ent_sdoheir_cns.a834793_Commercial_outcome_ip_cases_4_te_experiment` cases
...
DROP TABLE IF EXISTS `edp-prod-storage.edp_ent_sdoheir_cns.a834793_Commercial_outcome_ip6_4_te_experiment`;
CREATE OR REPLACE TABLE `edp-prod-storage.edp_ent_sdoheir_cns.a834793_Commercial_outcome_ip6_4_te_experiment`
OPTIONS (
    labels = [("owner", "pritha_ghosh_cvshealth_com"),("cost_center", "13070")]
    , expiration_timestamp = TIMESTAMP_ADD(CURRENT_TIMESTAMP(), INTERVAL 1 DAY)
)
...
WITH acute_ip6 AS (
    ...
    FROM  
        `edp-prod-storage.edp_ent_sdoheir_cns.a834793_Commercial_outcome_ip_cases_4_te_experiment` cases
    LEFT JOIN 
...
FROM 
    -- Full transformer cohort (created in Step 0)
    `edp-prod-storage.edp_ent_sdoheir_cns.a834793_Commercial_member_base_4_te_experiment` AS st
LEFT JOIN 
    acute_ip6 AS a
...
DROP TABLE IF EXISTS `edp-prod-storage.edp_ent_sdoheir_cns.a834793_Commercial_outcome_6mo_final_4_te_experiment`;
CREATE OR REPLACE TABLE `edp-prod-storage.edp_ent_sdoheir_cns.a834793_Commercial_outcome_6mo_final_4_te_experiment`
OPTIONS (
    labels = [("owner", "pritha_ghosh_cvshealth_com"),("cost_center", "13070")]
    , expiration_timestamp = TIMESTAMP_ADD(CURRENT_TIMESTAMP(), INTERVAL 1 DAY)
)
...
LEFT JOIN 
    `edp-prod-storage.edp_ent_sdoheir_cns.a834793_Commercial_outcome_ip6_4_te_experiment` ip6
...
FROM `edp-prod-storage.edp_ent_sdoheir_cns.a834793_Commercial_outcome_6mo_final_4_te_experiment`;

-- Query 2: Verify member count matches transformer cohort
SELECT 
    (SELECT COUNT(DISTINCT individual_id) FROM `edp-prod-storage.edp_ent_sdoheir_cns.a834793_Commercial_member_base_4_te_experiment`) AS transformer_cohort_count,
    (SELECT COUNT(DISTINCT individual_id) FROM `edp-prod-storage.edp_ent_sdoheir_cns.a834793_Commercial_outcome_6mo_final_4_te_experiment`) AS outcome_count,
    CASE WHEN 
        (SELECT COUNT(DISTINCT individual_id) FROM `edp-prod-storage.edp_ent_sdoheir_cns.a834793_Commercial_member_base_4_te_experiment`) =
        (SELECT COUNT(DISTINCT individual_id) FROM `edp-prod-storage.edp_ent_sdoheir_cns.a834793_Commercial_outcome_6mo_final_4_te_experiment`)
...
DROP TABLE IF EXISTS `edp-prod-storage.edp_ent_sdoheir_cns.a834793_Commercial_final_dataset_4_te_experiment`;
CREATE OR REPLACE TABLE `edp-prod-storage.edp_ent_sdoheir_cns.a834793_Commercial_final_dataset_4_te_experiment`
OPTIONS (
    labels = [("owner", "pritha_ghosh_cvshealth_com"),("cost_center", "13070")]
...
FROM st
LEFT JOIN `edp-prod-storage.edp_ent_sdoheir_cns.a834793_Commercial_outcome_6mo_final_4_te_experiment` lbl
  ON st.individual_id = lbl.individual_id AND st.index_dt = lbl.index_dt
LEFT JOIN `edp-prod-storage.edp_ent_sdoheir_cns.a834793_Commercial_post_status_4_te_experiment` inc
  ON st.individual_id = inc.individual_id AND st.index_dt = inc.index_dt
LEFT JOIN `edp-prod-storage.edp_ent_sdoheir_cns.a834793_Commercial_hpd_features_4_te_experiment` hpd
  ON st.individual_id = hpd.individual_id AND st.index_dt = hpd.index_dt
LEFT JOIN `edp-prod-storage.edp_ent_sdoheir_cns.a834793_Commercial_medcs_mdc_features_4_te_experiment` mdc
  ON st.individual_id = mdc.individual_id AND st.index_dt = mdc.index_dt
LEFT JOIN `edp-prod-storage.edp_ent_sdoheir_cns.a834793_Commercial_labrslt_features_4_te_experiment` labrslt
  ON st.individual_id = labrslt.individual_id AND st.index_dt = labrslt.index_dt
LEFT JOIN `edp-prod-storage.edp_ent_sdoheir_cns.a834793_Commercial_mbrshp_features_4_te_experiment` mbrshp
  ON st.individual_id = mbrshp.individual_id AND st.index_dt = mbrshp.index_dt 
LEFT JOIN `edp-prod-storage.edp_ent_sdoheir_cns.a834793_Commercial_mbrrtp_features_4_te_experiment` mbrrpt
  ON st.individual_id = mbrrpt.individual_id AND st.index_dt = mbrrpt.index_dt
LEFT JOIN `edp-prod-storage.edp_ent_sdoheir_cns.a834793_Commercial_cost_visit_features_4_te_experiment` cv
...
SELECT 
    ...
    COUNT(*) AS row_count
FROM `edp-prod-storage.edp_ent_sdoheir_cns.a834793_Commercial_hpd_features_4_te_experiment`
UNION ALL
SELECT 
    'MDC Features' AS table_name,
    COUNT(*) AS row_count
FROM `edp-prod-storage.edp_ent_sdoheir_cns.a834793_Commercial_medcs_mdc_features_4_te_experiment`
UNION ALL
SELECT 
    'Lab Features' AS table_name,
    COUNT(*) AS row_count
FROM `edp-prod-storage.edp_ent_sdoheir_cns.a834793_Commercial_labrslt_features_4_te_experiment`
UNION ALL
SELECT 
    'Membership Features' AS table_name,
    COUNT(*) AS row_count
FROM `edp-prod-storage.edp_ent_sdoheir_cns.a834793_Commercial_mbrshp_features_4_te_experiment`
UNION ALL
SELECT 
    'Member Relationship' AS table_name,
    COUNT(*) AS row_count
FROM `edp-prod-storage.edp_ent_sdoheir_cns.a834793_Commercial_mbrrtp_features_4_te_experiment`
UNION ALL
SELECT 
...
SELECT 
    ...
    COUNT(*) AS row_count
FROM `edp-prod-storage.edp_ent_sdoheir_cns.a834793_Commercial_post_status_4_te_experiment`
UNION ALL
SELECT 
    'Cost/Visit Features' AS table_name,
    COUNT(*) AS row_count
FROM `edp-prod-storage.edp_ent_sdoheir_cns.a834793_Commercial_cost_visit_features_4_te_experiment`
UNION ALL
SELECT 
...
SELECT 
    ...
    (SELECT COUNT(*) FROM `edp-prod-storage.edp_ent_sdoheir_cns.a834793_Commercial_member_base_4_te_experiment`) AS base_count,
    (SELECT COUNT(*) FROM `edp-prod-storage.edp_ent_sdoheir_cns.a834793_Commercial_final_dataset_4_te_experiment`) AS final_count,
    CASE WHEN 
        (SELECT COUNT(*) FROM `edp-prod-storage.edp_ent_sdoheir_cns.a834793_Commercial_member_base_4_te_experiment`) =
        (SELECT COUNT(*) FROM `edp-prod-storage.edp_ent_sdoheir_cns.a834793_Commercial_final_dataset_4_te_experiment`)
