-- pull recent 90 days of claim from daily claim table
create or replace table `{{ dag_run.conf["DEC_DATASET"] }}.{{ dag_run.conf["prefix"] }}_daily_claims`
...
, b_dt as (
    ...
    where 		
    	clm.srv_start_dt >= date("2020-01-01") 
